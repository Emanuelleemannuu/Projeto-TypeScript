import {adicionar, editar, remover} from './funcoes_crud.ts'

import {adicionandoVerificacao, converter, exibirTarefas, ordenar, filtrar, marcarConcluida, pesquisar, resumir} from './funcoes_exibir.ts'
